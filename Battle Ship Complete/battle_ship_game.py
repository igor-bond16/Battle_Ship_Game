...
p1_counter = 0
p2_counter = 0
victory = pygame.mixer.Sound('/home/igor-bond/Desktop/Battle Ship Complete/Short_triumphal_fanfare-John_Stracke-815794903.wav')
lose = pygame.mixer.Sound('/home/igor-bond/Desktop/Battle Ship Complete/Sad_Trombone-Joe_Lamb-665429450.wav')
failed = pygame.mixer.Sound('/home/igor-bond/Desktop/Battle Ship Complete/Video_Game_Splash-Ploor-699235037.wav')
bombed_sound = pygame.mixer.Sound('/home/igor-bond/Desktop/Battle Ship Complete/Bomb-SoundBible.com-891110113.wav')
bgm = pygame.mixer.music.load('/home/igor-bond/Desktop/Battle Ship Complete/Epic-battle-music-grzegorz-majcherczyk-heroica.mp3')
...
def p2_field(win):
    ...
    drawnumbers(765,win)
    font = pygame.font.SysFont('comicsens',100)
    text = font.render("AI's Field",5,(0,0,255))
    win.blit(text,(980-text.get_width()/2,730))
